...
function Transaction({navigation}) {
    ...
    <DropShadow style={styles.card}>
      ...
      <View style={{flexDirection: 'row', paddingTop: 8}}>
        <View style={styles.cardDetailDescCont}>
          <Text style={styles.cardDetailDesc}>
            Order {'\n'} Value
          </Text>
          <Text style={styles.cardDetailDescVal}>Rs {item.order_value}</Text>
        </View>
        <View style={styles.cardDetailDescCont}>
          <Text style={styles.cardDetailDesc}>Loyalty {'\n'} Used</Text>
          <Text style={styles.cardDetailDescVal}>Rs {item.points_redeemed}</Text>
        </View>
        <View style={styles.cardDetailDescCont}>
          <Text style={styles.cardDetailDesc}>Loyalty {'\n'} Rewarded</Text>
          <Text style={styles.cardDetailDescVal}>Rs {item.points_rewarded} </Text>
        </View>
        <View style={styles.cardDetailDescCont}>
          <Text style={styles.cardDetailDesc}>Cash {'\n'} Collected</Text>
          <Text style={styles.cardDetailDescVal}>Rs {item.cash_collected}</Text>
        </View>
      </View>
    <Text></Text>
    </DropShadow>
  ...
  return (
    <SafeAreaView
      ...
      style={styles.main}>
        <FlatList data={transactionHistory}
        renderItem={Item}
